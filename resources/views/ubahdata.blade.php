        ...
        <div class="grid gap-8">
            <div id="back-div" class="bg-gradient-to-r from-blue-500 to-purple-500 rounded-[26px] m-4">
                <div
                    ...
                    <h1 class="pb-6 font-bold dark:text-gray-400 text-4xl text-center cursor-default">Form Ubah Data
                        Pelanggan</h1>
                    <form action="{{ route('updatedata', $DataPelanggan->id) }}" method="post" class="space-y-3">
                        @csrf
                        @method('put')
                        <div>
                            <label for="text" class="mb-2  dark:text-gray-400 text-lg">Nama Lengkap</label>
                            <input id="text" name="name" value="{{ $DataPelanggan->name }}"
                        ...
                        <div>
                            ...
                            <input id="email" name="email" value="{{ $DataPelanggan->email }}"
                        ...
                        <div>
                            ...
                            <input id="telepon" name="telepon" value="{{ $DataPelanggan->telepon }}"
                                class="border p-3 mt-3 shadow-md dark:bg-indigo-700 dark:text-gray-300  dark:border-gray-700 placeholder:text-base focus:scale-105 ease-in-out duration-300 border-gray-300 rounded-lg w-full"
                        ...
                        <div>
                            ...
                            <input id="alamat" name="alamat" value="{{ $DataPelanggan->alamat }}"
                                class="border p-3 mt-3 shadow-md dark:bg-indigo-700 dark:text-gray-300  dark:border-gray-700 placeholder:text-base focus:scale-105 ease-in-out duration-300 border-gray-300 rounded-lg w-full"
                        ...
                        <a href="/hero" class="text-blue-800 flex items-center justify-center">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
